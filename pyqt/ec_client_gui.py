...
import socket
import threading
from PyQt5.QtWidgets import QApplication, QWidget, QGridLayout, QVBoxLayout, QLabel, QPushButton, QDial, QLineEdit, QGraphicsView, QGraphicsScene, QFrame, QDialog
...
class SkeletonPanel(QWidget):
    def __init__(self):
        ...
        self.signals.receivedData.connect(self.handle_received_data)
    ...
    def initUI(self):
        ...
        self.send_button = QPushButton("Send All Wheel Positions", self)
        self.send_button.clicked.connect(self.send_all_wheel_positions)
        right_layout.addWidget(self.send_button, 5, 0, 1, 2)
    ...
    def add_wheel_control(self, layout, row, col, wheel_index, include_speed_buttons=True):
        ...
        angle_input.setPlaceholderText("Position")
